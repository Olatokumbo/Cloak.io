  ...
  return (
    <div className="py-2 flex overflow-auto w-full whitespace-nowrap border-b-2 border-gray-100 border-solid">
      <div className="m-auto flex">
        ...
        <Link href="/categories/writing-and-editing"><h5 className="text-gray-700 mx-4 cursor-pointer hover:text-gray-500">Writing & Editing</h5></Link>
        <Link href="/categories/education-and-training"><h5 className="text-gray-700 mx-4 cursor-pointer hover:text-gray-500">Education & Training</h5></Link>
        <Link href="/categories/media-and-communication"><h5 className="text-gray-700 mx-4 cursor-pointer hover:text-gray-500">Media & Communication</h5></Link>
