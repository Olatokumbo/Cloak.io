...
<div className="py-5 sm:px-16 px-6">
      ...
      <h1 className="text-2xl font-bold my-3">Interpretation and Definitions</h1>
      ...
      <ul>
        ...
        <li className="my-5">
          <p>
            ...
            this Agreement) refers to Cloak.io.
          </p>
        </li>
        <li className="my-5">
          <p>
        ...
        <li className="my-5">
          <p>
            <strong>Website</strong> refers to Cloak.io, accessible from{" "}
            <a
              href="https://cloak-io.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://cloak-io.vercel.app/
            </a>
          </p>
        </li>
        <li className="my-5">
      ...
      <h1 className="text-2xl font-bold my-5">Collecting and Using Your Personal Data</h1>
      <h2 className="text-2xl font-bold my-5">Types of Data Collected</h2>
      <h3 className="text-xl font-bold my-5">Personal Data</h3>
      <p>
      ...
      <h3 className="text-xl font-bold my-5">Usage Data</h3>
      <p className="my-5">Usage Data is collected automatically when using the Service.</p>
      <p className="my-5">
      ...
      <h3 className="text-xl font-bold my-5" >Information from Third-Party Social Media Services</h3>
      <p className="my-5">
        The Company allows You to create an account and log in to use the
        Service through the following Third-party Social Media Services:
      </p>
      <ul>
        <li className="my-5">Google</li>
        <li className="my-5">Facebook</li>
      ...
      <h3 className="text-2xl font-bold my-5">Tracking Technologies and Cookies</h3>
      <p>
      ...
      <ul>
        <li className="my-5">
          ...
          <p className="my-5">Type: Session Cookies</p>
          <p className="my-5">Administered by: Us</p>
          <p className="my-5">
        ...
        <li className="my-5">
          ...
          <p className="my-5">Type: Persistent Cookies</p>
      ...
      <h2 className="my-5 font-bold text-2xl">Use of Your Personal Data</h2>
      <p className="my-5">The Company may use Personal Data for the following purposes:</p>
      <ul>
        <li className="my-5">
          <p>
      ...
      <h2 className="my-5 font-bold text-2xl">Retention of Your Personal Data</h2>
      <p className="my-5">
      ...
      <h2 className="my-5 font-bold text-2xl">Transfer of Your Personal Data</h2>
      <p className="my-5">
      ...
      <h3 className="my-5 text-xl font-semibold">Business Transactions</h3>
      <p className="my-5">
      ...
      <h3 className="my-5 text-xl font-semibold">Law enforcement</h3>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="my-5 text-xl font-semibold" >Other legal requirements</h3>
      <p className="my-5">
        The Company may disclose Your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li className="my-5">Comply with a legal obligation</li>
        ...
        <li className="my-5">Protect against legal liability</li>
      </ul>
      <h2 className="my-5 text-2xl font-bold">Security of Your Personal Data</h2>
      <p className="my-5">
      ...
      <h1 className="my-5 text-2xl font-bold">Children's Privacy</h1>
      <p className="my-5">
      ...
      <h1 className="my-5 text-2xl font-bold">Changes to this Privacy Policy</h1>
      <p className="my-5">
      ...
      <h1 className="my-5 font-bold text-2xl">Contact Us</h1>
      <p className="my-5">
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul>
        <li className="my-5">
          <p>By email: faithodesola@gmail.com</p>
        </li>
        <li className="my-5">
          <p>By phone number: +2347089621694</p>
        </li>
      </ul>
    </div>
</Layout>
